    ...
    def __init__(self, parent, controller):
        ...
        def buyer_folder():
            ...
            data_dict = {'Property Address': Property_Address, 'City': '', 'State': '', 'Zip': '', 'County': '',
                        ...
                        'Buyer Email': client_email, 'Buyer Email 2': '', 'Buyer Cell': '', 'Buyer Work': '', 'Buyer Home': '',
                        'Buyer Fax': '', 'Home Warranty': '', 'Home Inspec\x98on Co': '', 'Termite Co': '', 'FuelOil Co': '',
                        'Well  Sep\x98c Co': '', 'Lender': Lender_Contact, 'Loan Officer Name': lender[Lender_Contact][2], 'Loan Officer Phone': '', 'Loan Officer Email': lender[Lender_Contact][0],
        ...
        def buyer_email():
            ...
            html_body = f"""
                <p class=MsoNormal>Good {Time}, {Client_Name}!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>My name is Harrison Goehring and I am the Office Manager for the Rick Cox Realty Group. I work with {Agent_Name} and will be assisting with your purchase of {Property_Address}. Attached, you will find copies of the fully-executed contract and any addenda or disclosures in conjunction with your closing.</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>Should you have any questions regarding closing or any aspect of the transaction leading up to that point, please feel free to reach out me. My congratulations to you on your upcoming home purchase!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>CC: Your agent, {Agent_Name}; Team Administrator, Amy Foldes;</p>
                <p class=MsoNormal></p>
        ...
        def attorney_email():
            ...
            html_body =f"""
                <p class=MsoNormal>Good {Time}, {Attorney_Name}!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>{Agent_Name}'s client would like to use your office for the title and settlement work needed for their purchase of {Property_Address}. Please find the ratified contract, transaction information sheet and tax record attached!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal> Please note that the selling agent's commission for this transaction will be {Commission}. Additionally, our brokerage will charge a $395.00 Administrative Fee to the purchaser at closing. Please overnight both checks to our office at <b> 2913 Fox Chase Lane, Midlothian, VA 23112. </b> Thank you! </p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>CC: {Agent_Name}, Selling Agent; Team Administrator, Amy Foldes;</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal> Kind Regards, </p>
                <p class=MsoNormal></p>
                <p class=MsoNormal></p>
        ...
        def lender_email():
            ...
            mailItem = olApp.CreateItem(0)
            mailItem.Subject = f'New Purchase Contract - {Property_Address} for ({Client_Name})'
            mailItem.BodyFormat = 1
            ...
            html_body =f"""
                <p class=MsoNormal>Good {Time}, {Lender_Name}!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>Please find a ratified contract attached for {Agent_Name}'s client, {Client_Name}! {EMD}</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal> Kind Regards, </p>
                <p class=MsoNormal></p>
                <p class=MsoNormal></p>
        ...
        def listing_agent_email():
            ...
            html_body =f"""
                <p class=MsoNormal>Good {Time}, {Listing_Agent}!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>My name is Harrison Goehring and I am the Office Manager for the Rick Cox Realty Group. I will be assisting {Agent_Name} and their client on the purchase of {Property_Address}. I look forward to working with you!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>{attorney_msg} Would you mind providing me with the contact for the Seller's Attorney or Title Company who will be handling the deed preparation for the Seller once that information becomes available?</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>Additionally, would your seller be willing to share who their current utility providers for Electricity, Water/Sewer, Internet, Trash and Gas are?</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>CC: {Agent_Name}, Selling Agent; Team Administrator, Amy Foldes;</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>Kind regards & thanks,</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal></p>
                <p class=MsoNormal style='mso-margin-top-alt:auto;mso-margin-bottom-alt:auto;mso-add-space:auto'><b><span style='font-size:14.0pt;font-family:"Arial",sans-serif;color:#1F3864'>Harrison Goehring</span> </b><o:p></o:p></p>
                <p class=MsoNormal style='mso-margin-top-alt:auto;mso-margin-bottom-alt:auto;mso-add-space:auto'><b><span style='font-family:"Arial",sans-serif'>Office Manager @ The Rick Cox Realty Group</span> </b><o:p></o:p></p>
    ...
    def __init__(self, parent, controller):
        ...
        def attorney_email():
            ...
            html_body =f"""
                <p class=MsoNormal>Good {Time}, {Attorney_Name}!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>{Agent_Name}'s client would like to use your office for the deed preparation necessary for their sale of {Property_Address}. Please find the ratified contract, transaction information sheet and tax record attached!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal> Please note that the commission for this transaction will be {Commission_Split}. Additionally, our brokerage will charge a $395.00 Administrative Fee to the seller at closing. Should the purchaser's attorney ask, we would like both checks mailed to our office at <b> 2913 Fox Chase Lane, Midlothian, VA 23112. </b> Thank you! </p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>CC: {Agent_Name}, Listing Agent; Amy Foldes, Team Administrator</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal> Kind Regards, </p>
                <p class=MsoNormal></p>
                <p class=MsoNormal></p>
...
class TeamMeeting(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def team_meeting_email():
            ...
            html_body =f"""
                <p class=MsoNormal>Good {AM_PM}, RCRG Team!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>Friendly reminder that we will be conducting our meeting this Wednesday, {Date}, at {Time}. Hope to see you all then!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal> Kind Regards, </p>
                <p class=MsoNormal></p>
                <p class=MsoNormal></p>
...
class ZillowTeam(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def team_meeting_email():
            ...
            html_body =f"""
                <p class=MsoNormal>Good {AM_PM}, {Team_On} Team!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>This is a friendly reminder that you are now on to receive Zillow leads for the week.</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal> Kind Regards, </p>
                <p class=MsoNormal></p>
                <p class=MsoNormal></p>
            ...
            html_body =f"""
                <p class=MsoNormal>Good {AM_PM}, {Team_Off} Team!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>This is a friendly reminder that you are now paused for Zillow leads for the week.</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal> Kind Regards, </p>
                <p class=MsoNormal></p>
                <p class=MsoNormal></p>
    ...
    def __init__(self, parent, controller):
        ...
        def buyer_zillow_email():
            ...
            html_body =f"""
                <p class=MsoNormal>Good {Time}, {Client_Name}!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>Congratulations on your purchase of {Property_Address}! Thank you for choosing to work with {Agent_Name} and our real estate group.</p>
                <p class=MsoNormal></p>
                ...
                <p class=MsoNormal>{Zillow_Link}</p>
                <p class=MsoNormal>We sincerely appreciate your business!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal> Kind Regards, </p>
                <p class=MsoNormal></p>
                <p class=MsoNormal></p>
    ...
    def __init__(self, parent, controller):
        ...
        def seller_zillow_email():
            ...
            html_body =f"""
                <p class=MsoNormal>Good {Time}, {Client_Name}!</p>
                <p class=MsoNormal></p>
                <p class=MsoNormal>Congratulations on your sale of {Property_Address}! Thank you for choosing to work with {Agent_Name} and our real estate group.</p>
                <p class=MsoNormal></p>
